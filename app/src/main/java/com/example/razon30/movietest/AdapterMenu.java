...
public class AdapterMenu extends BaseAdapter{
    ...
    public AdapterMenu(ArrayList<MovieDownloadLink> downloadLinks, Context context) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        BootstrapButton textView = (BootstrapButton) view.findViewById(R.id.itemyearmenu);
